#!/usr/bin/env python3
"""
Hardware Simulator for Energy Monitoring IoT Devices
Generates realistic energy consumption data for multiple home devices
and sends to ThingsBoard via MQTT and HTTP
"""
...
class EnergyDeviceSimulator:
    ...
    def simulate_data_point(self):
        ...
        # Try HTTP first, fallback to MQTT
